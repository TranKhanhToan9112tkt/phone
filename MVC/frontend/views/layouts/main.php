                        ...
                        <div class="logo text-center">
                            ...
                            <h1>
                                <a href="index.php?controller=home&action=index">
                                    <img src="assets/images/Artboard-1.png" style="height: 121px;" alt="Digital World" class="img-responsive" />
                                </a>
                            </h1>
                                    ...
                                    <div class="account-list">
                                        <ul class="account-links" style="text-align: left; font-weight: bold; font-size: 20px;">
                                            ...
                                            <?php if (isset($_SESSION['user'])) : ?>
                                                ...
                                                echo '<li><a href="index.php?controller=Login&action=inforUser&id='.$id.'" title="Thông tin cá nhân">
